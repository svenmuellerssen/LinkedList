...
describe('Test deletion functionality', function(done) {

  it('Test the delete a node functionality', function() {
    ...
    async.eachSeries(
      ...
      function callback(err) {
        ...
        (node.username).should.be.a.String().and.be.eql("Name ohne Ende");
