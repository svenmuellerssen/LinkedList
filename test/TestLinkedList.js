...
describe('Test linked list functionality', function(done) {
  ...
  it('Test standard node functionality (going forward from list start to the end)', function() {
    ...
    async.eachSeries(
      ...
      function callback(err) {
        ...
        should.exist(node);
        (node).should.be.instanceof(listNode);
        (node.getValue()).should.be.an.Object();
        (node.getValue().id).should.be.eql(4);
        (node.getValue().field4).should.be.a.Number().and.be.eql(10.45);
        ...
        (node).should.be.instanceof(listNode);
        (node.getValue()).should.be.an.Object();
        (node.getValue().id).should.be.eql(1);
        (node.getValue().field4).should.be.a.Boolean().and.be.not.eql(true);
        ...
        (node).should.be.instanceof(listNode);
        (node.getValue()).should.be.an.Object();
        (node.getValue().id).should.be.eql(23);
  ...
  it('Test standard node functionality with not default node object (Also from start tot the end)', function() {
